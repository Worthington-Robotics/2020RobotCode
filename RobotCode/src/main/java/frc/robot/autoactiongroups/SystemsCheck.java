...
import frc.robot.actions.climberactions.KickstandToggleAction;
import frc.robot.actions.climberactions.PinToggleAction;
...
public class SystemsCheck extends StateMachineDescriptor {
    public SystemsCheck() {
        ...
        addParallel(new Action[] {new KickstandToggleAction(), new PinToggleAction(), new DummyDrive(true), new Shift(), new LightsStateTest(2)}, 5000);
        addParallel(new Action[] {new ArmAction(), new LightsStateTest(3)}, 5000);
        addParallel(new Action[] {new LightsStateTest(4)}, 5000);
