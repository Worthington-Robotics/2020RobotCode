...
public class SkewLeft extends StateMachineDescriptor {
    public SkewLeft() {
        ...
        waypoints.add(new Waypoint(new Translation2d(0,0), 48));
        waypoints.add(new Waypoint(new Translation2d(60, 0), 48));
        waypoints.add(new Waypoint(new Translation2d(120, 24), 48));
